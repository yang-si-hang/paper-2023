"""
使用liver.msh作为几何网格文件,控制所有节点,以到达期望位置
created at 2024-09-18 by hsy
"""
...
class MyObject(SoftObject):
    def __init__(self, shape, seed_size, file, contact_list):
        ...
        self.dt = 1. / 100
        self.dots_idx = list(set(range(self.PARTICLE_NUM)) - set(self.fix_particle_list) - set(self.contact_particles_list))
...
def main():
    ...
    soft_obj = MyObject(obj_shape, 0.01, 'Mesh/liver.msh', contact_idx)
