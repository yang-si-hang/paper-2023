...
def main(args):
    ...
    # record_variable = ['timestamp', 'actual_TCP_pose', 'actual_TCP_speed']
    record_variable = ['timestamp', 'target_qd', 'actual_q', 'actual_qd']
    dt = 1 / args.frequency
    rtde_r = RTDEReceive(args.ip, args.frequency)
    rtde_r.startFileRecording(args.output, record_variable)
