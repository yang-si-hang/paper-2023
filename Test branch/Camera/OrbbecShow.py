...
def main():
    ...
    try:
        ...
        try:
            color_profile: VideoStreamProfile = profile_list.get_video_stream_profile(2560, 0, OBFormat.RGB, 25)
        except OBError as e:
            print(e)
    ...
    cv2.namedWindow("Color Viewer", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Color Viewer", 800, 600)
    while True:
        try:
